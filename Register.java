    ...
    class RegisterActionListener implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e) 
        {
            ...
            else if (ob == btn1)// 单击确认按钮 
            {
                ...
                String s1 = like1.isSelected() ? like1.getText() + "  " : "";
                String s2 = like2.isSelected() ? like2.getText() + "  " : "";
                String s3 = like3.isSelected() ? like3.getText() + "  " : "";
                System.out.println("爱好：" + s1 + s2 + s3);
                System.out.println("喜欢的编程语言：" + website.getSelectedItem());
                registerFrame.dispose(); //销毁窗口
            } 
